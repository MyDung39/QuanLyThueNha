...
CREATE TABLE Phong (
    ...
    TrangThai NVARCHAR(50) NOT NULL DEFAULT N'Trống' CHECK (TrangThai IN (N'Trống', N'Đang thuê', N'Dự kiến')),
...
CREATE TABLE NguoiThue (
    ...
    SoGiayTo VARCHAR(12) NULL, --CCCD/CMND, Hộ chiếu,...
    NgayTao DATETIME NOT NULL DEFAULT GETDATE(),
    NgayCapNhat DATETIME NOT NULL DEFAULT GETDATE()
);
GO
...
CREATE TABLE HopDong (
    ...
    ThoiHan INT NOT NULL DEFAULT 12, -- Tính theo tháng
...
-- Bảng Chi tiết người thuê trong hợp đồng (Contract_Tennant Detail)
CREATE TABLE HopDong_NguoiThue (
    ...
    TrangThaiThue NVARCHAR(50) NOT NULL DEFAULT N'Đang ở',
...
CREATE TABLE ThanhToan (
    ...
    SoTienDaThanhToan DECIMAL(18,2) NOT NULL DEFAULT 0 CHECK (SoTienDaThanhToan >= 0),
    ...
    TrangThai NVARCHAR(50) NOT NULL DEFAULT N'Chưa trả' CHECK (TrangThai IN (N'Chưa trả', N'Đã trả', N'Trả một phần')),
    NgayTao DATETIME NOT NULL DEFAULT GETDATE(),
    NgayCapNhat DATETIME NOT NULL DEFAULT GETDATE()
);
GO
...
INSERT INTO Nha (MaNha, MaNguoiDung, DiaChi, GhiChu)
...
VALUES
('NT001', N'Nguyễn Vân Anh', '0909000111', 'vananh@gmail.com', '047864238845'),
('NT002', N'Lê Thị Bích', '0909000222', 'lebich@gmail.com', '070131475844'),
('NT003', N'Trần Ngọc Minh Châu', '0909000333', 'minhchau@gmail.com', '033175486447'),
('NT004', N'Tạ Minh Ngọc Hân', '0567789995', 'ngochanta@gmail.com', '085411238573');
GO

INSERT INTO HopDong (MaHopDong, MaPhong, ChuNha, TienCoc, NgayBatDau, ThoiHan, TrangThai)
VALUES
('HD001', 'NHA001-PHONG001', 'ND001', 2500000, '2025-01-01', 12, N'Hiệu lực'),
('HD002', 'NHA001-PHONG002', 'ND001', 3500000, '2025-02-01', 12, N'Hiệu lực');
GO
...
('HDN001', 'DV1', N'kWh', 4000, 80),      -- Tiền điện
('HDN001', 'DV2', N'm3', 12000, 15),      -- Tiền nước
