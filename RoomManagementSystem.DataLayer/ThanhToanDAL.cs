...
namespace RoomManagementSystem.DataLayer
{
    ...
    {
        private string connectionString = "Data Source=DESKTOP-4JTJGR2\\SQLEXPRESS;Initial Catalog=QLTN;Integrated Security=True;Encrypt=True;Trust Server Certificate=True";
