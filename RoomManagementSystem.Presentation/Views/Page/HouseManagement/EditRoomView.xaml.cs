...
namespace RoomManagementSystem.Presentation.Views.Page.HouseManagement
{
    ...
    public partial class EditRoomView : UserControl
    {
        ...
        private void NumericTextBox_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            // keep digits and at most one '.' or ','
            int sepCount = 0;
            char sepChar = '\0';
        ...
        private void NumericTextBox_LostFocus(object sender, RoutedEventArgs e)
{
    ...
    // Diện tích hoặc chi phí: chỉ cho số, tối đa 2 thập phân
    if (!System.Text.RegularExpressions.Regex.IsMatch(text, @"^[0-9]+([\.,][0-9]{0,2})?$"))
    {
        string field = tb.Name == "AreaTextBox" ? "Diện tích" : tb.Name == "MonthlyCostTextBox" ? "Chi phí theo tháng" : "Trường này";
        MessageBox.Show($"{field} nhập sai định dạng, chỉ được nhập số (tối đa 2 số thập phân)!", "Cảnh báo", MessageBoxButton.OK, MessageBoxImage.Warning);
        return;
    }
