...
namespace RoomManagementSystem.Presentation.Views.Page.ReportManagement
{
    ...
    {
        private readonly ObservableCollection<ProfitItem> _items = new ObservableCollection<ProfitItem>();
        ...
        {
            _items.Clear();
            _items.Add(new ProfitItem { STT = 1, DonViThu = "Doanh thu tháng", SoTien = "2,000,000" });
            _items.Add(new ProfitItem { STT = 2, DonViThu = "Chi phí tháng", SoTien = "2,000,000" });
        }
