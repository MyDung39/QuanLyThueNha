...
namespace RoomManagementSystem.BusinessLayer
{
    public class DashBoardValue
    {
        ...
        public DataTable ChiTietPhiThang(string thoiKy)
        {
            BaoCaoChiPhiBLL bccp = new BaoCaoChiPhiBLL();
            return bccp.GetChiPhiThang(thoiKy);
        }
        public decimal TongChiPhiDien(string thoiKy)
        {
            BaoCaoChiPhiBLL bc = new BaoCaoChiPhiBLL();
            DataTable dt = bc.GetChiPhiThang(thoiKy);
            decimal sum = 0;
        ...
        public decimal TongChiPhiNuoc(string thoiKy)
        {
            BaoCaoChiPhiBLL bc = new BaoCaoChiPhiBLL();
            DataTable dt = bc.GetChiPhiThang(thoiKy);
            decimal sum = 0;
        ...
        public decimal TongChiBaoTri(string thoiKy)
        {
            BaoCaoChiPhiBLL bc = new BaoCaoChiPhiBLL();
            DataTable dt = bc.GetChiPhiThang(thoiKy);
            decimal sum = 0;
